...
function transformRules(self: any, rules: any, result: any) {
...
var cleanPropertyName = function (name: string) {
...
var mediaNameGenerator = function (name: string) {
  return "@media " + name;
};
var nameGenerator = function (name: string) {
...
export function transformCss(inputCssText: string) {
  if (!inputCssText) {
